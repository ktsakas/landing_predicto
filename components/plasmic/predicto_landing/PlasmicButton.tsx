...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 0OtwdvXGHhRRX/css
    ...
    >
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__tXszp)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__o3NCk)}
                role={"img"}
              />
            ),
